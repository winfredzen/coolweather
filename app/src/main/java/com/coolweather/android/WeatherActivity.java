...
public class WeatherActivity extends AppCompatActivity {
    ...
    public void requestWeather(final String weatherId) {
        ...
        String weatherUrl = "https://free-api.heweather.net/s6/weather?location=" + weatherId + "&key=HE1902281454511985";
    ...
    private void showWeatherInfo(Weather weather) {
        ...
        for (Lifestyle suggestion : weather.getLifestyleList()) {

            String type = suggestion.getType();

            if (type.equals("comf")) {
                comfortText.setText(suggestion.getTxt());
            } else if (type.equals("cw")) {
                carWashText.setText(suggestion.getTxt());
            } else if (type.equals("sport")) {
                sportText.setText(suggestion.getTxt());
            }
        }
